...
instance: Neg Rotation:=⟨ neg_Rotation⟩

#check Sub
def sub_Rotation: Rotation→ Rotation→ Rotation
| r0,r =>-r
|r, r0=>r
|r120,r120=>r0
|r120,r240=>-r120
...
[outParam <| AddGroup G] extends AddAction G P,
  VSub G P where
  [nonempty : Nonempty P]
...
#reduce (s0 -ᵥ s120)+ᵥ s240
#reduce (s120-ᵥ s120)-ᵥ r120
#reduce (r0 -ᵥ r120) +ᵥ r120
