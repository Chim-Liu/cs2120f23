...
-- rules
-- 1. id is the identity element for op
...
/-
Semantic expression goes with Interpretation I for atomic proposition, and
combine every subexpression together. For example,
I: var → Bool
e0 = var 1
e1 = ¬e0
I e1 = I ¬e0 = ¬ Ie0
Interpretation only works on viable atomic proposition.
-/
